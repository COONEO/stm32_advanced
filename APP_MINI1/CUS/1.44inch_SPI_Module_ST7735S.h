...
#define LCD_LED_ON() HAL_GPIO_WritePin(GPIOB, GPIO_PIN_9, GPIO_PIN_SET)   // 打开 LCD 背光
#define LCD_LED_OFF() HAL_GPIO_WritePin(GPIOB, GPIO_PIN_9, GPIO_PIN_RESET) // 关闭 LCD 背光
...
#define LCD_GPIO_PORT GPIOB  // Change GPIOB to whatever GPIO port you're using
