...
// GPIO Pin 定义，确保这些宏定义与实际硬件连接相符
#define LCD_LED_PIN    GPIO_PIN_13
#define LCD_CS_PIN     GPIO_PIN_15
#define LCD_RS_PIN     GPIO_PIN_14
#define LCD_RST_PIN    GPIO_PIN_12

// GPIO Port 定义，根据实际使用的GPIO端口调整
#define LCD_GPIO_PORT  GPIOB

// 使用HAL库操作GPIO
#define LCD_LED_ON()   HAL_GPIO_WritePin(LCD_GPIO_PORT, LCD_LED_PIN, GPIO_PIN_SET)
#define LCD_LED_OFF()  HAL_GPIO_WritePin(LCD_GPIO_PORT, LCD_LED_PIN, GPIO_PIN_RESET)
